                  ...
                  for (var i = 0; i < datesList.length; i++) {
                    ...
                    for (var j = 0; j < u.days.length; j++) {
                      if (datesList[i] == u.days[j].date) {
                        ...
                        dayFound = true;
                        if (u.days[j].usersData.leaveSign == "لم يتم تسجيل المغاره") {
                          tabelContent += '<td><p>' + u.days[j].usersData.leaveTime + ' </p></td>'
                        } else {
                          tabelContent += '<td><img src="' + u.days[j].usersData.leaveSign +
                            '" style="width: 75px;"><p>' + u.days[j].usersData.leaveTime + ' </p></td>'
                        }
                        break
                      }
                      if (!dayFound)
                        tabelContent += '<td>لم يتم تسجيل الانصراف</td>'
